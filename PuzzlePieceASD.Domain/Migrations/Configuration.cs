namespace PuzzlePieceASD.Domain.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PuzzlePieceASD.Domain.DAL.UserContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "PuzzlePieceASD.Domain.DAL.UserContext";
        }

        protected override void Seed(PuzzlePieceASD.Domain.DAL.UserContext context)
        {
